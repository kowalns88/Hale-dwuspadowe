...
function getTrapezoidalParams(type: 'T18' | 'T35' | 'ROOF_SANDWICH') {
  if (type === 'T35') {
    return { height: 0.008, plateau: 0.050, valley: 0.200, period: 0.400 };
  }
...
function createTrapezoidalGeometry(
  ...
  const segAlongWave = Math.min(waveCount * 6, 1500); // 6 segments per wave period for smooth trapezoids
