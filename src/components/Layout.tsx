...
export function Layout() {
  ...
  return (
    <main className="flex flex-col md:flex-row flex-1 overflow-hidden">
      ...
      <aside className="w-full md:w-[380px] h-[40vh] md:h-auto bg-surface-primary border-b md:border-b-0 md:border-r border-border overflow-hidden">
        <FormPanel
          params={params}
      ...
      <section className="w-full md:flex-1 flex-1 bg-[#1e1e2e] relative">
        <Scene
          params={params}
          results={results}
          cladding={cladding}
